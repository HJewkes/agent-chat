...
| `planner`     | opus   | Read, Grep, Glob, Write, Bash       | Edit, git commit/push/checkout/reset/stash | `none`            | **iterm-pane** | explore pass of an explore-then-implement split (CC-136); writes only its plan file |
