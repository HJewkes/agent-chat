...
| P9  | Permission relay — **shipped 2026-07-27** as a read-only observatory (I1 below), gated behind a remote flag (currently on). See `docs/permission-relay.md` for verified mechanics.                                                                                                                            | `broker/socket.ts:681`, `broker/event-log.ts:82` |
